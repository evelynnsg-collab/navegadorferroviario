      ...
      <div style={{background:"#141927",borderRadius:14,padding:"13px 15px",border:`1px solid ${value?"#2E3A50":"#252B3E"}`}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:8}}>
          ...
          <div style={{display:"flex",gap:5}}>
            {value&&<button onMouseDown={e=>{e.preventDefault();handleClear();}} style={{background:"#1E2438",border:"none",color:"#666",borderRadius:20,padding:"3px 10px",fontSize:10,cursor:"pointer"}}>✕ LIMPAR</button>}
        ...
        <div style={{position:"relative"}}>
          ...
          <input
            ...
            placeholder={value?`Alterar ${label}...`:`Buscar ${label}...`}
            style={{width:"100%",background:"#0B0F1C",border:"1px solid #252B3E",borderRadius:10,padding:"10px 12px 10px 34px",color:"#fff",fontSize:14,outline:"none",boxSizing:"border-box"}}
          />
        </div>
      </div>
...
export default function App() {
  ...
  return(
    <div style={{minHeight:"100vh",background:"linear-gradient(160deg,#080C18,#0B0F1C)",fontFamily:"'Segoe UI',system-ui,sans-serif",color:"#fff",maxWidth:430,margin:"0 auto"}}>
      <div style={{position:"sticky",top:0,zIndex:50,background:"rgba(8,12,24,0.96)",backdropFilter:"blur(20px)",borderBottom:"1px solid #1A1F2E",padding:"15px 18px 13px"}}>
        <div style={{display:"flex",alignItems:"center",justifyContent:"space-between"}}>
          <div style={{display:"flex",alignItems:"center",gap:11}}>
            ...
            <div>
              <div style={{fontWeight:900,fontSize:16,letterSpacing:2.5,color:"#F5A623",lineHeight:1}}>NAVEGADOR FERROVIÁRIO</div>
      ...
      <div style={{padding:"14px 16px 120px"}}>
        ...
        <div style={{display:"flex",alignItems:"center",justifyContent:"center",margin:"7px 0",position:"relative"}}>
          ...
          <button onClick={trocar} style={{position:"relative",zIndex:1,background:"#141927",border:"1px solid #252B3E",borderRadius:"50%",width:34,height:34,display:"flex",alignItems:"center",justifyContent:"center",cursor:"pointer",fontSize:15,color:"#666"}}>⇄</button>
        </div>
